...
public class DownldAndOpenPDFTest {
	...
	public void testVerifyPDFTextInBrowser() {
		...
		driver.get("http://shml.infanion.com/en");
		//driver.findElement(By.linkText("PDF flyer")).click();
		Assert.assertTrue(verifyPDFContent("D:\\SeleniumAutomateDownloadFiles\\bpost-label.pdf", "323257001658161017"));
	}
	...
	public boolean verifyPDFContent(String strURL, String reqTextInPDF) {
		...
		try {
			...
			File file = new File("D:\\SeleniumAutomateDownloadFiles\\bpost-label.pdf");
